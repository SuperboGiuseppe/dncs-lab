...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "router-1" do |router1|
    ...
    router1.vm.provision "file", source: "./NetplanConfigurations/50-router-1.yaml", destination: "/tmp/50-router.yaml"
    router1.vm.provision "shell", path: "./Scripts/router.sh"
  ...
  config.vm.define "router-2" do |router2|
    ...
    router2.vm.provision "file", source: "./NetplanConfigurations/50-router-2.yaml", destination: "/tmp/50-router.yaml"
    router2.vm.provision "shell", path: "./Scripts/router.sh"
  ...
  config.vm.define "switch" do |switch|
    ...
    switch.vm.provision "shell", path: "./Scripts/switch.sh"
  ...
  config.vm.define "host-a" do |hosta|
    ...
    hosta.vm.provision "file", source: "./NetplanConfigurations/50-host-a.yaml", destination: "/tmp/50-host.yaml"
    hosta.vm.provision "shell", path: "./Scripts/host.sh"
  ...
  config.vm.define "host-b" do |hostb|
    ...
    hostb.vm.provision "file", source: "./NetplanConfigurations/50-host-b.yaml", destination: "/tmp/50-host.yaml"
    hostb.vm.provision "shell", path: "./Scripts/host.sh"
  ...
  config.vm.define "host-c" do |hostc|
    ...
    hostc.vm.provision "file", source: "./NetplanConfigurations/50-host-c.yaml", destination: "/tmp/50-host.yaml"
    hostc.vm.provision "shell", path: "./Scripts/docker_container.sh"
    hostc.vm.provision "shell", path: "./Scripts/host.sh"
